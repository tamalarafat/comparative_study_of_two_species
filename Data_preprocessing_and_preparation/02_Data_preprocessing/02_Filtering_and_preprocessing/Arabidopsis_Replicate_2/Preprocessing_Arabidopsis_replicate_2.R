...
load("/netscratch/dep_tsiantis/grp_laurent/tamal/2023/Beginning_of_a_compendium/Input_Data/Orthologues_data/Arabidopsis_REP_2_Ortho_data.RData")

thaliana_genes = rownames(Ortho_COL_REP_2)
...
Ortho_COL_REP_2 <- Ortho_COL_REP_2[genes_to_keep, ]
...
COL_2E <- CreateSeuratObject(counts = Ortho_COL_REP_2, project = "COL_2E", min.features = 200)
