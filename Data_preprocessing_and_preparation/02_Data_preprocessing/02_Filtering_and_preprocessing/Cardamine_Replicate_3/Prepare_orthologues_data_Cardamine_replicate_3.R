...
load("/netscratch/dep_tsiantis/grp_laurent/tamal/2023/Beginning_of_a_compendium/Input_Data/Orthologues_data/Cardamine_REP_3_Ortho_data.RData")

# Get the gene ids in the cardamine dataset
hirsuta_genes = rownames(Ortho_OX_REP_3)
...
Ortho_OX_REP_3 <- Ortho_OX_REP_3[genes_to_keep, ]
...
OX_3E <- CreateSeuratObject(counts = Ortho_OX_REP_3, project = "OX_3E", min.features = 200)
