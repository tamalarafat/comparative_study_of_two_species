...
#### Running suggest K
#### Running suggest K
sg_L <- suggestLambda(WT_Species, k = 50, num.cores = 10)

save(sg_L, file = "suggest_lambda_wt_species.Rdata")

writeLines(capture.output(sessionInfo()), "Session_info_suggest_lambda_wt_species.txt")
