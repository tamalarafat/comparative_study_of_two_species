...
GEP_markers = read.csv("/home/yasir/Documents/Thesis_PhD/Chapter_2/Liger_analysis_with_CC/Cluster_DEGs_Markers_Candidates/Cluster_candidates/Cluster_3/Top_genes_GEP_identity/GEP_43/Cluster_3_GEP_43_markers.csv")
