...
GEP_markers = read.csv("/home/yasir/Documents/Thesis_PhD/Chapter_2/Liger_analysis_with_CC/Cluster_DEGs_Markers_Candidates/Cluster_candidates/Cluster_17/Top_genes_GEP_identity/GEP_5/Cluster_17_GEP_5_markers.csv")
...
markers_description = merge(Cluster_marker, description, by.x = "gene_ID", by.y = "AT_ID", all.x = TRUE)[-c(8, 9)]
