...
ATH = read.csv("/home/yasir/Documents/Thesis_PhD/Chapter_3/Analysis_objects/Annotation_files/Gene_description_CH_V12_orthologs.csv")
rownames(ATH) <- ATH$CH_ID

# Load the markers from GEPs
GEP_markers = read.csv("/home/yasir/Documents/Thesis_PhD/Chapter_3/Analysis_with_CC/Cluster_DEGs_Markers_Candidates/Cluster_candidates/Cluster_4/Top_genes_GEP_identity/Combine_GEP_markers/GEP_markers_cluster_4.csv")
...
# Cluster 0 marker
specific_markers_list = loadRData("/home/yasir/Documents/Thesis_PhD/Chapter_3/Analysis_with_CC/Cluster_DEGs_Markers_Candidates/DEGs_and_Markers.RData")[[3]]
...
markers_description = merge(Cluster_marker, description, by.x = "gene_ID", by.y = "CH_ID", all.x = TRUE)
