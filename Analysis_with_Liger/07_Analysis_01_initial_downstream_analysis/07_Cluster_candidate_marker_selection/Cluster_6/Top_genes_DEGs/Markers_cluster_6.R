...
GEP_markers = read.csv("/home/yasir/Documents/Thesis_PhD/Chapter_2/Liger_analysis_with_CC/Cluster_DEGs_Markers_Candidates/Cluster_candidates/Cluster_6/Top_genes_GEP_identity/Combine_GEP_markers/GEP_markers_cluster_6.csv")
