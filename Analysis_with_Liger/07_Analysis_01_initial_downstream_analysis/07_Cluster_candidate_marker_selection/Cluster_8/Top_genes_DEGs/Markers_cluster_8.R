...
GEP_markers = read.csv("/home/yasir/Documents/Thesis_PhD/Chapter_2/Liger_analysis_with_CC/Cluster_DEGs_Markers_Candidates/Cluster_candidates/Cluster_8/Top_genes_GEP_identity/GEP_19/Cluster_8_GEP_19_markers.csv")
