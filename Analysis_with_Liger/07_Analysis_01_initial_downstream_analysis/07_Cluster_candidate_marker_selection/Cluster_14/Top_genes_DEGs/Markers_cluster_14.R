...
GEP_markers = read.csv("/home/yasir/Documents/Thesis_PhD/Chapter_2/Liger_analysis_with_CC/Cluster_DEGs_Markers_Candidates/Cluster_candidates/Cluster_14/Top_genes_GEP_identity/GEP_1/Cluster_14_GEP_1_markers.csv")
