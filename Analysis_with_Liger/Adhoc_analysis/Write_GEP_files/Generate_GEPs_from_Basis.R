...
load(paste0(projects_dir, "comparative_study_of_two_species/Analysis_with_Liger/Analysis_objects/Gene_clusters/Basis.RData"))

# Directory path -  store the outputs on this directory
storing_dir = paste0(projects_dir, "comparative_study_of_two_species/Analysis_with_Liger/Analysis_output")
