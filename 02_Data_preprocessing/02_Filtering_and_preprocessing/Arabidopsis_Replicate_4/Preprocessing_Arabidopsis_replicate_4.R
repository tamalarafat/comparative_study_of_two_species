...
load("/netscratch/dep_tsiantis/grp_laurent/tamal/2023/Beginning_of_a_compendium/Input_Data/Orthologues_data/Arabidopsis_REP_4_Ortho_data.RData")

thaliana_genes = rownames(Ortho_COL_REP_4)
...
Ortho_COL_REP_4 <- Ortho_COL_REP_4[genes_to_keep, ]
...
COL_5E <- CreateSeuratObject(counts = Ortho_COL_REP_4, project = "COL_5E", min.features = 200)
