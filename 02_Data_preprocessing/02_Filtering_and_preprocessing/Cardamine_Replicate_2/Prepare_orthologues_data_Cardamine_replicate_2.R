...
Ortho_OX_REP_2 = prepare_ortho_data(input_data = OX_data_2E, ortho_data = ortho_table, ortho_column_name_of_gene_ids = "C.hirsutaOX", ortho_column_name_to_assign = "A.thaliana.TAIR10")

# save(Ortho_OX_REP_2, file = "Cardamine_REP_2_Ortho_data.RData")