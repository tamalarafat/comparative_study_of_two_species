...
load("/netscratch/dep_tsiantis/grp_laurent/tamal/2023/Beginning_of_a_compendium/Input_Data/Orthologues_data/Cardamine_REP_4_Ortho_data.RData")

# Get the gene ids in the cardamine dataset
hirsuta_genes = rownames(Ortho_OX_REP_4)
...
Ortho_OX_REP_4 <- Ortho_OX_REP_4[genes_to_keep, ]
...
OX_7E <- CreateSeuratObject(counts = Ortho_OX_REP_4, project = "OX_7E", min.features = 200)
...
generate_data_summary_plot(OX_7E, covariate = "nCount_RNA", figure_name_suffix = "_CH_REP_4", binwidth = 1000)

generate_data_summary_plot(OX_7E, covariate = "nFeature_RNA", figure_name_suffix = "_CH_REP_4", binwidth = 100)

ggsave(plot = VlnPlot(OX_7E, features = "percent.mt") + 
         xlab("") + 
         ylab("percent.mt") + 
       ...
       filename = "Mitochondrial_distribution_CH_REP_4.png", width = 12, height = 12, dpi = 300)

ggsave(plot = VlnPlot(OX_7E, features = "percent.pt") + 
         xlab("") + 
         ylab("percent.pt") + 
         ...
         theme(axis.title.x = element_text(size = 18, face = "bold", colour = "black"), 
               ...
               title =  element_text(size = 18, face = "bold", colour = "black"),
               legend.position = "none"), 
       filename = "Chloroplast_distribution_CH_REP_4.png", width = 12, height = 12, dpi = 300)
